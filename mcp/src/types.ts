...
export const ProgressUpdateSchema = z.object({
  ...
  stage: z.enum(["initialization", "analysis", "risk_management", "portfolio_management"]),
  message: z.string(),
  progress: z.number(),
...
export const GenerateAnalysisToolSchema = z.object({
  ...
  initial_cash: z.number().optional().describe("Initial cash amount for portfolio"),
  margin_requirement: z.number().optional().describe("Margin requirement percentage"),
  show_reasoning: z.boolean().optional().describe("Whether to show detailed reasoning"),
  selected_analysts: z.array(z.string()).optional().describe("List of analyst names to use"),
...
export const GetAvailableAnalystsToolSchema = z.object({});
...
export type GetPortfolioStatusTool = z.infer<typeof GetPortfolioStatusToolSchema>;
export type GetAvailableAnalystsTool = z.infer<typeof GetAvailableAnalystsToolSchema>;
